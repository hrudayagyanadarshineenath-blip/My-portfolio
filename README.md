# 🌸 Hrudaya Gyanadarshinee Nath — Personal Portfolio
...
* **Projects:** A showcase of my development and machine learning projects.
* **Interactive Neural Network Animation:** A dynamic background with glowing nodes, connecting pathways, and travelling signal pulses.
* **Mouse Interaction:** Nearby network nodes respond to mouse movement.
* **Responsive Design:** Designed to adapt to different screen sizes.
* **Smooth Scrolling:** Smooth navigation between website sections.
...
* Nodes are connected through nearby pathways.
* Mouse movement excites nearby nodes.
...
Feel free to explore my projects and connect with me through my portfolio.
